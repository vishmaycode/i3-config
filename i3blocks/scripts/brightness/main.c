...
main(int argc, char *argv[]) {
  static const char *default_abp = "/sys/class/backlight/amdgpu_bl0/actual_brightness";
  static const char *default_mbp = "/sys/class/backlight/amdgpu_bl0/max_brightness";
